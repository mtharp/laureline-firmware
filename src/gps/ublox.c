...
static const uint8_t ublox_cfg5[] = {
    0xB5, 0x62, 0x06, 0x24, 0x24, 0x00, 0x07, 0x00,
...
ublox_configure(void) {
    ...
    serial_write(gps_serial, (const char *)ublox_cfg5, sizeof(ublox_cfg5));
}
