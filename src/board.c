...
static const gpio_cfg_t gpio_cfg[4][16] = {
	{
		...
		{GPIO_MODE_50MHZ	| GPIO_AFIO_PP,		1}, /* PA8  - MCO */
		...
		{GPIO_MODE_INPUT	| GPIO_INPUT_PUPD,	1}  /* PA15 - */
	}, {
		{GPIO_MODE_INPUT	| GPIO_INPUT_PUPD,	1}, /* PB0  - */
		{GPIO_MODE_INPUT	| GPIO_INPUT_PUPD,	1}, /* PB1  - */
		...
		{GPIO_MODE_2MHZ		| GPIO_OUTPUT_PP,	1}, /* PC9  - PPSEN */
		...
		{GPIO_MODE_INPUT	| GPIO_INPUT_PUPD,	1}, /* PD1  - OSC_OUT */
